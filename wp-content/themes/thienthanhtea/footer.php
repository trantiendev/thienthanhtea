          ...
          <div class="col col-5 col-offset-1 col--md-offset-1 col--md-5 col--sm-12">
            <nav class="footer-nav">
              <ul class="footer-link-list">
                ...
                <li class="footer-link-list-item"><a href="#">Link</a></li>
                <li class="footer-link-list-item"><a href="#">Link</a></li>
                <li class="footer-link-list-item"><a href="#">Link</a></li>
                <li class="footer-link-list-item"><a href="#">Link</a></li>
              </ul>
              <ul class="footer-link-list">
                <li class="footer-link-list-item">Products</li>
                <li class="footer-link-list-item"><a href="#">FAQ</a></li>
                <li class="footer-link-list-item"><a href="#">Contact Us</a></li>
              </ul>
            </nav>
          </div>
          <div class="col col-2 col-offset-1 ol--md-offset-1 col--md-2 col--sm-12">
