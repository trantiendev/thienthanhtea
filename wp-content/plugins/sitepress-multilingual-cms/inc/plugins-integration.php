...
function wpml_themes_integration_setup() {
	...
	if ( defined( 'ET_BUILDER_THEME' ) || defined( 'ET_BUILDER_PLUGIN_VERSION' ) ) {
		...
		$divi_theme_builder = new WPML\Compatibility\Divi\ThemeBuilder( $sitepress );
		$divi_theme_builder->add_hooks();

		$divi_dynamic_content = new WPML\Compatibility\Divi\DynamicContent( $sitepress );
		$divi_dynamic_content->add_hooks();
	}
}
